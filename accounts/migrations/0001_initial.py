    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('citizen', 'Citizen'), ('doctor', 'Doctor'), ('city_staff', 'City Staff'), ('agri_officer', 'Agricultural Officer'), ('admin', 'Government Admin')], default='citizen', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documents', models.FileField(blank=True, null=True, upload_to='approval_docs/')),
